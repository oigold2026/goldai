...
export type AIRequest = { message: string; language?: string; profile?: Pick<UserProfile, "userGroup" | "country" | "preferredLanguage" | "educationLevel" | "classOrYear" | "programme">; attachments?: MessageAttachment[]; studyContext?: StudyContext };
